...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e =
        "undefined" != typeof globalThis ? globalThis : e || self).Snowflakes =
        t());
})(this, function () {
  "use strict";
  function e() {
  ...
  function o(e) {
    for (var t, a = [], n = 1; n < arguments.length; n++)
      a[n - 1] = arguments[n];
    var i = a.filter(l);
    i.length && (t = e.classList).add.apply(t, i);
  }
  function s(e) {
    for (var t, a = [], n = 1; n < arguments.length; n++)
      a[n - 1] = arguments[n];
    var i = a.filter(l);
    i.length && (t = e.classList).remove.apply(t, i);
  }
  function r(e, t) {
  ...
  function c(e, t, a) {
    return Math.floor(h(e, 0, 20, t, a));
  }
  var m = (function () {
    function e(e) {
      var i = this;
      (this.size = 0),
        ...
        (this.handleAnimationEnd = function (e) {
          ...
          o &&
            e.target === o &&
            (t(o, { left: i.getLeft() }), n((l = o)), l.offsetHeight, a(l));
        });
      ...
      this.update(e),
        ...
        o(
          s,
          "snowflake__inner",
          e.types ? "snowflake__inner_type_" + r(0, e.types) : "",
          e.wind ? "snowflake__inner_wind" : "",
          e.rotation
    ...
    return (
      ...
      (e.prototype.update = function (e) {
        if (this.elem && this.elemInner) {
          var a = e.minSize === e.maxSize;
          (this.sizeInner = a ? 0 : r(0, 20)),
            (this.size = c(this.sizeInner, e.minSize, e.maxSize));
          var n = this.getAnimationProps(e),
            i = {
              animationName: "snowflake_gid_".concat(e.gid, "_y"),
          ...
          a ||
            (i.opacity = String(
              h(this.size, e.minSize, e.maxSize, e.minOpacity, e.maxOpacity)
            )),
            t(this.elem, i);
          var l = "snowflake_gid_".concat(e.gid, "_x_").concat(this.sizeInner);
          t(this.elemInner, {
            animationName: l,
      ...
      (e.prototype.resize = function (e) {
        if (this.elem) {
          var a = this.getAnimationProps(e);
          t(this.elem, { animationDuration: a.animationDuration });
        }
      }),
      ...
      (e.prototype.getAnimationProps = function (e) {
        ...
        return {
          ...
          animationDuration: String(
            h(this.size, e.minSize, e.maxSize, t, a) + "s"
          ),
        };
      }),
      e
  ...
  return (function () {
    ...
    return (
      ...
      Object.defineProperty(l, "defaultParams", {
        get: function () {
          return e();
        },
        enumerable: !1,
      ...
      (l.prototype.resize = function () {
        var e = this.width(),
          t = this.height();
        if (t !== this.containerSize.height) {
      ...
      (l.prototype.appendContainer = function () {
        ...
        return (
          o(
            e,
            "snowflakes",
            "snowflakes_gid_".concat(this.gid),
      ...
      (l.prototype.injectStyle = function (e, t) {
        return (function (e, t) {
          return (
            t ||
        ...
        })(e.replace(/_gid_value/g, "_gid_".concat(this.gid)), t);
      }),
      ...
      (l.prototype.appendFlakes = function () {
        ...
        this.flakes = [];
        for (var a = 0; a < this.params.count; a++) this.flakes.push(new m(t));
        this.flakes
          .sort(function (e, t) {
      ...
      (l.prototype.getAnimationStyle = function () {
        for (
          var e = Math.ceil(this.params.maxSize * Math.sqrt(2)),
            t = this.isBody()
              ? "calc(100vh + ".concat(e, "px)")
              : "".concat(this.height() + e, "px"),
            a = this.gid,
            n = [
      ...
      (l.prototype.removeStyles = function () {
        l.instanceCounter || (i(this.mainStyleNode), delete this.mainStyleNode),
